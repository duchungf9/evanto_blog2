...
use App\TCG\Voyager\Src\Commands\AdminCommand;
use App\TCG\Voyager\Src\Commands\ControllersCommand;
use App\TCG\Voyager\Src\Commands\InstallCommand;
use App\TCG\Voyager\Src\Commands\MakeModelCommand;
...
class VoyagerServiceProvider extends ServiceProvider
{
    ...
    protected function registerAlertComponents()
    {
        ...
        foreach ($components as $component) {
            $class = 'App\\TCG\\Voyager\\Src\\Alert\\Components\\'.ucfirst(camel_case($component)).'Component';
    ...
    {
        $default_widgets = ['App\\TCG\\Voyager\\Src\\Widgets\\UserDimmer', 'TCG\\Voyager\\Widgets\\PostDimmer', 'TCG\\Voyager\\Widgets\\PageDimmer'];
    ...
    {
        $publishablePath = app_path().'/tcg/voyager/publishable';
    ...
    public function registerConfigs()
    {
        $this->mergeConfigFrom(
            dirname(__DIR__).'/tcg/voyager/publishable/config/voyager.php', 'voyager'
        );
    }
    ...
    protected function registerFormFields()
    {
        ...
        foreach ($formFields as $formField) {
            ...
            VoyagerFacade::addFormField("App\\TCG\\Voyager\\Src\\FormFields\\{$class}");
        }

        VoyagerFacade::addAfterFormField(\App\TCG\Voyager\Src\FormFields\After\DescriptionHandler::class);
