...
use App\TCG\Voyager\Database\DatabaseUpdater;
use App\TCG\Voyager\Database\Schema\Column;
use App\TCG\Voyager\Database\Schema\Identifier;
...
class VoyagerDatabaseController extends Controller
{
    ...
    public function updateBread(Request $request, $id)
    {
        ...
        /* @var \App\TCG\Voyager\Src\Models\DataType $dataType */
        try {
